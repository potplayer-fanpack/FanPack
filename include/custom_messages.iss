...
;pl.msg_moveAP=Przenoszenie AviSynth i PxShader...
;pl.msg_unregLV=Wyrejestrowywanie LAVVideo.ax...
;pl.msg_unregLA=Wyrejestrowywanie LAVAudio.ax...
;pl.msg_unregLS=Wyrejestrowywanie LAVSplitter.ax...
;pl.msg_unregVR=Wyrejestrowywanie MpcVideoRenderer64.ax...
;pl.msg_unregxysubfil=Wyrejestrowywanie XySubFilter.dll...
;pl.msg_unregsanear=Wyrejestrowywanie sanear64.ax...
;pl.msg_tor=Strumieniowe przesy³anie treœci cyfrowych przez HTTP
;
...
;
pl.tsk_group2=Ustawienia dodatkowe:
pl.tsk_renaudio=Wybór automatyczny (zalecane)
pl.tsk_directsound=Domyœlne urz¹dzenie DirectSound
pl.tsk_wasapi=Wbudowany WASAPI Audio Renderer
pl.tsk_sanear=Zewnêtrzny Sanear Audio Renderer (mo¿na u¿yæ zamiast WASAPI)
pl.tsk_playlist=Dodaj dodatkowe listy odtwarzania (playlisty YT, Torrent, IPTV)
;
...
pl.comp_icaros=Icaros - umo¿liwia wyœwietlanie miniatur plików multimedialnych w Eksploratorze Windows
